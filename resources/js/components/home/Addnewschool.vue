<template>
 ...
 <span class="d-flex  mr-5 "><h3>ادخال بيانات مدرسة جديد </h3></span>
...
<form action="/saveschool" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    <label  for="inputEmail3" class="d-none d-xs-none d-sm-none d-md-block d-lg-block d-xl-block col-sm-2 col-form-label"> اسم المدرسة</label>
    <div class="col-sm-10">
   ...
   <div class="form-group row">
    <label for="inputEmail3" class=" d-none d-xs-none d-sm-none d-md-block d-lg-block d-xl-block  col-sm-2 col-form-label"> ايميل المدرسة </label>
    <div class="col-sm-10">
   ...
   <div class="form-group row">
    <label for="inputEmail3" class="  d-none d-xs-none d-sm-none d-md-block d-lg-block d-xl-block col-sm-2 col-form-label"> عنوان المدرسة </label>
    <div class="col-sm-10">
   ...
   <div class="form-group row">
    <label  class=" d-none d-xs-none d-sm-none d-md-block d-lg-block d-xl-block col-sm-2 col-form-label"> نوع المدرسة  </label>
         <div class="col-sm-10">
   ...
   <div class="form-group row" >
    <label for="" class=" d-none d-xs-none d-sm-none d-md-block d-lg-block d-xl-block col-sm-2 col-form-label "> عن المدرسة </label>
    <div class="col-sm-10">
   ...
   <div class="form-group row">
    <label  class=" d-none d-xs-none d-sm-none d-md-block d-lg-block d-xl-block col-sm-2 col-form-label"> صورة للمدرسة  </label>
    <div class="col-sm-10">
 ...
 <br> 
  <div class="form-group row">
    <div class="col-sm-8">
      <button type="submit"  @click="saveschool" class="btn btn-primary col-sm-8">اضافة</button>
    </div>
  </div>
</form>
